...
include('../link/desigene/db.php');
            $sql = "SELECT * FROM employeedata AS e INNER JOIN leavereq AS l ON e.EmployeeNo = l.EmployeeNo WHERE l.Statusofmanger = 'ACCEPT' AND l.LeaveFrom >= '$currentDate' AND e.DY_Supervisor = $empid";
