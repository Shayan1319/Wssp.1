...
with special reference to knowledge of work, quality, and quantity of output. 
	 ...
	 been stated in Part II (2)?</p>
                        ...
                        <div class="my-5">
                            ...
                            <div class="my-5 col-6 ">
                                <label for="">Name of the reporting officer.</label>
                                <input type="text" value="<?php echo $_SESSION['name']?>" name="NameOfCountersigningOfficer" id="" class="form-control">
                            </div>
                            <div class="my-5 col-6 ">
                                <label for="">Designation</label>
                                <input type="text" value="<?php echo $_SESSION['Designation']?>" name="DesignationOfCountersigningOfficer" id="" class="form-control">
                            </div>
                            <div class="my-5 col-6 ">
                                <label for="">Date</label>
                                <input type="text" value="<?php echo date('Y-D-M')?>" name="DateOfCountersigningOfficer" id="" class="form-control">
                            </div>
                            </div>
                    </div>
                        </div>
