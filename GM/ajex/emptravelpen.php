...
include('../link/desigene/db.php');
            $sql = "SELECT * FROM employeedata AS e  INNER JOIN travelrequest AS t ON e.EmployeeNo = t.EmployeeNo WHERE t.Statusofmanger = 'ACCPET' AND t.StatusofGM = 'PENDING' AND  t.DepartureOn >= '$currentDate'";
