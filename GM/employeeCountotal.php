                        ...
                        while ($rowofTP = mysqli_fetch_array($select)) {
                            if (isset($_POST["submit" . $a])) {
                                ...
                                foreach ($Ids as $key => $Id) {
                                    ...
                                    $salarySql = mysqli_query($conn, "UPDATE `atandece` SET `GMStatus`='{$statusValue}', `GMStatusData`='$Date' WHERE `id`='$Id'");
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="headingEmp<?php echo $m . $a ?>">
                                                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEmp<?php echo $m . $a ?>" aria-expanded="true" aria-controls="collapseEmp<?php echo $m . $a ?>">
                                                                ...
                                                                $resultatdcont = mysqli_query($conn, "SELECT COUNT(*) AS TotalAttendance FROM atandece WHERE `Employeeid` = $employee_nocount AND `Date`>='$fromdatetoatt' AND `Date`<='$todatetoatt'");
                                                            ...
                                                            <div class="accordion-body">
                                                                <table class="table">
                                                                    ...
                                                                    <tbody id="table-data">
                                                                        ...
                                                                        $selectat = mysqli_query($conn, "SELECT * FROM `atandece` WHERE  `Employeeid`='$empnumber' AND `Date`>='$fromdate' AND `Date`<='$todate'");
                                                                        while ($rowoeatend = mysqli_fetch_array($selectat)) {
                                                                        ?>
                                                                            <tr>
                                                                                <td>#</td>
                                                                                <td><?php echo $rowomang['EmployeeNo'] ?></td>
                                                                                <td><?php echo $rowomang['fName'] ?> <?php echo $rowomang['mName'] ?> <?php echo $rowomang['lName'] ?></td>
                                                                                <td><?php echo $rowomang['Job_Tiltle'] ?></td>
                                                                                <td><?php echo $rowomang['Employee_Class'] ?></td>
                                                                                <td><?php echo $rowoeatend['Date'] ?></td>
                                                                                <td><?php echo $rowoeatend['Shift'] ?></td>
                                                                                <td><?php echo $rowoeatend['Tehsil'] ?></td>
                                                                                <td><?php echo $rowoeatend['status'] ?></td>
                                                                                <td><?php echo $rowoeatend['DDorOT'] ?></td>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                    <input type="hidden" value="<?php echo $rowoeatend['id'] ?>" name="Id[<?php echo $rowoeatend['id'] ?>]">
                                                                                    <div class="form-check">
