...
if (!isset($_SESSION['loginid']) || !isset($_SESSION['EmployeeNumber']) || $_SESSION['Designation'] != 'CEO') {
  ...
  exit; // Ensure that the script stops execution after the header redirection
    ...
    if (isset($_POST['submit'])) {
        ...
        $CEOQ1=$_POST['CEOQ1'];
        $CEOQ2=$_POST['CEOQ2'];
        $NameOfCountersigningOfficer=$_POST['NameOfCountersigningOfficer'];
        $DesignationOfCountersigningOfficer=$_POST['DesignationOfCountersigningOfficer'];
        $DateOfCountersigningOfficer=$_POST['DateOfCountersigningOfficer'];
        $RemarksOfSecondCountersigningOfficer=$_POST['RemarksOfSecondCountersigningOfficer'];
        $NameOfSecondCountersigningOfficer=$_POST['NameOfSecondCountersigningOfficer'];
        $DesignationOfSecondCountersigningOfficer=$_POST['DesignationOfSecondCountersigningOfficer'];
        $DateOfSecondCountersigningOfficer=$_POST['DateOfSecondCountersigningOfficer'];
        // Perform the database insertion
        $insertQuery = "UPDATE `employee_performance` SET `Intelligence`='$Q1',`ConfidenceAndWillPower`='$Q2',`AcceptanceOfResponsibility`='$Q3',`ReliabilityUnderPressure`='$Q4',`FinancialResponsibility`='$Q5',`RelationsWithSuperiors`='$Q6',`RelationsWithColleagues`='$Q7',`RelationsWithSubordinates`='$Q8',`BehaviorWithPublic`='$Q9',`AblityToDecideRoutineMatters`='$Q10',`KnowledgeOfRelavantLawsETC`='$Q11',`Q2`='$Q12',`Integrity`='$Integrity',`Q3`='$Q13',`SpecialAptitude`='$Special_aptitude',`RecommendedForFutureTraining`='$Recommendedforfuturetraining',`OverallGradingByReportingOfficer`='$Q14',`OverallGradingByCountersigningOfficer`='$Q15',`FitnessForPromotionByReportingOfficer`='$Q16',`FitnessForPromotionByCountersigningOfficer`='$Q17',`NameOfReportingOfficer`='$name',`DesignationOfReportingOfficer`='$Designation', `DateOfReportingOfficer`='$data',`CEOQ1`='$CEOQ1',`CEOQ2`='$CEOQ2',`NameOfCountersigningOfficer`='$NameOfCountersigningOfficer',`DesignationOfCountersigningOfficer`='$DesignationOfCountersigningOfficer',`DateOfCountersigningOfficer`='$DateOfCountersigningOfficer',`RemarksOfSecondCountersigningOfficer`='$RemarksOfSecondCountersigningOfficer',`NameOfSecondCountersigningOfficer`='$NameOfSecondCountersigningOfficer',`DesignationOfSecondCountersigningOfficer`='$DesignationOfSecondCountersigningOfficer',`DateOfSecondCountersigningOfficer`='$DateOfSecondCountersigningOfficer' WHERE `Id`=$emil";
...
with special reference to knowledge of work, quality, and quantity of output. 
	 ...
	 been stated in Part II (2)?</p>
                        ...
                        <div class="my-5">
                            ...
                            <textarea name="CEOQ1" id="CEOQ1"><?php echo $row['CEOQ1'] ?></textarea>
                                <script>
                                    CKEDITOR.replace('CEOQ1');
                                </script>
                            </div>
                            <div class="my-5">
                            <p class="fw-bold">
                            ...
                            <textarea name="RemarksOfSecondCountersigningOfficer" id="RemarksOfSecondCountersigningOfficer"><?php echo $row['RemarksOfSecondCountersigningOfficer'] ?></textarea>
                                <script>
                                    CKEDITOR.replace('RemarksOfSecondCountersigningOfficer');
                                </script>
                            </div>
                            <div class="row">
                            ...
                            <div class="my-5 col-6 ">
                                <label for="">Name of the reporting officer.</label>
                                <input type="text" value="<?php echo $_SESSION['name']?>" name="NameOfSecondCountersigningOfficer" id="" class="form-control">
                            </div>
                            <div class="my-5 col-6 ">
                                <label for="">Designation</label>
                                <input type="text" value="<?php echo $_SESSION['Designation']?>" name="DesignationOfSecondCountersigningOfficer" id="" class="form-control">
                            </div>
                            <div class="my-5 col-6 ">
                                <label for="">Date</label>
                                <input type="date" value="<?php echo date('Y-D-M')?>" name="DateOfSecondCountersigningOfficer" id="" class="form-control">
                            </div>
                            </div>
                    </div>
                        </div>
