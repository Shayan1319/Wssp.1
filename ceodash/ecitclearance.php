...
if (!isset($_SESSION['loginid']) || !isset($_SESSION['EmployeeNumber'])) {
  ...
  if(isset($_POST['submit'])){
    ...
    $date= date('Y-M-D');
    $insertQuery = "UPDATE `employee_exit` SET `Handover_File`='$HRMS_Updated',`Handover_File_Remarks`='$HRMS_UpdatedRemarks',`Handover_Info`='$EOBI_Guidance',`Handover_Info_Remarks`='$EOBI_GuidanceRemarks',`Capital_Equipment`='$Last_Salary_Payment',`Capital_Remarks`='$Last_Salary_PaymentRemarks',`HOD_Other`='$Leave_Encashment',`HOD_Remarks`='$Leave_EncashmentRemarks',`HOD_Approved_Date`='$date' WHERE `Id`=$id";
