...
if (!isset($_SESSION['loginid']) || !isset($_SESSION['EmployeeNumber']) || $_SESSION['Designation'] != 'CEO') {
  ...
  if (isset($_POST['submit'])) {
      ...
      if ($result) {    echo '<script>alert("Data is inserted");</script>';
                    ...
                    <div class="row mt-5 p-3">
                        ...
                        <div class="col-md-4 my-2">
                          <div class="form-group">
                            ...
                            <input value="<?php echo $fetchdata['CNICUpdate']?>" id="cNo" type="text" name="CNIC" placeholder="CNIC" class="form-control" autocomplete="off" oninput="validateCNIC(this)">
