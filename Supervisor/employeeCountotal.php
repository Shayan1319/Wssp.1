...
<div class="accordion-item">
                        ...
                        <table class="table">
                            ...
                            <thead style="background-color: darkblue;">
                                <tr>
                                    ...
                                    <th scope="col" class="text-white">Employee Manager</th>
                            ...
                            <tbody id="table-data">
                                ...
                                <tr>
                                    ...
                                    <td scope="col"><?php echo $rowoemp['EmployeeNo'] ?><input hidden type="number" name="Employeeid[]" value="<?php echo $rowoemp['EmployeeNo'] ?>"></td>
                                    <td scope="col"><?php echo $rowoemp['Employee_Manager'] ?></td>
    ...
    <div class="form-check">
        <input class="form-check-input" value="Leave" type="radio" name="status[<?php echo $i; ?>]" id="Leave<?php echo $rowoemp['Id'] . $i; ?>">
        <label class="form-check-label" for="Leave<?php echo $rowoemp['Id'] . $i; ?>">
            Leave
        </label>
    </div>
</div>
