                  ...
                  <div class="form-group">
                    ...
                    <?php
                      include ('link/desigene/db.php');
                        ...
                        $sql = "SELECT SUM(`TotalDays`) AS empleave FROM `leavereq` WHERE `EmployeeNo`=$emil AND `Statusofmanger`='ACCEPT' AND `StatusofGm`='ACCEPT' AND `LeaveTo` >= '$fromdate' AND `LeaveTo` <= '$todate';";
